...
BuildRequires: python24-devel >= %{python_minver}
BuildRequires: python24 >= %{python_minver}
...
Requires:      python24 >= %{python_minver}
Requires:      libxslt, libxml2, openldap, libpng, libjpeg-turbo, zlib, freetype, openssl
AutoReqProv:   no

%description
This packages provides %{shortname} virtualenv for Plone 3.
